...
printf '  - No git commit (session dir is gitignored by default); the\n'
printf '    brainstorming skill notes the skipped commit in its status.\n'
printf '    Users who want committed session history remove the\n'
printf '    docs/auto-superpowers/sessions/ line from .gitignore.\n'
